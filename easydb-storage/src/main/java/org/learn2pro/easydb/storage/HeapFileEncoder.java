...
public class HeapFileEncoder {
     ...
     *
     * @param tuples the tuples - a list of tuples, each represented by a list of integers that are the field
    ...
    /**
     * Convert the specified input text file into a binary page file. <br> Assume format of the input file is (note that
     * only integer fields are supported):<br> int,...,int\n<br> int,...,int\n<br> ...<br> where each row represents a
     * tuple.<br>
     * <p>
     * The format of the output file will be as specified in HeapPage and HeapFile.
     *
