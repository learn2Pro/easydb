...
public class HeapPageId implements PageId {
    ...
    private int tableId;
    /**
     * the unique page number in table
     */
    private int pageNo;
    ...
    /**
     * Return a representation of this object as an array of integers, for writing to disk.  Size of returned array must
     * contain number of integers that corresponds to number of args to one of the constructors.
     */
