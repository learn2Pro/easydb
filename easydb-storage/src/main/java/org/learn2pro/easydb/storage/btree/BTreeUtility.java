...
public class BTreeUtility {
    ...
    /**
     * @return a Tuple with an IntField for every element of tupdata and RecordId(BTreePageId(1, 2, BTreePageId.LEAF),
     *         3)
     */
    ...
    /**
     * @return a Tuple with a 'width' IntFields each with value n and with RecordId(BTreePageId(1, 2, BTreePageId.LEAF),
     *         3)
     */
    ...
    /**
     * @return a BTreeEntry with an IntField with value n and with RecordId(BTreePageId(tableid,2,
     *         BTreePageId.INTERNAL), 3)
     */
    ...
    /**
     * @return a BTreeEntry with an IntField with value key and with RecordId(BTreePageId(tableid,2,
     *         BTreePageId.INTERNAL), 3)
     */
     ...
     * @throws IOException
     */
    public static BTreeLeafPage createRandomLeafPage(BTreePageId pid, int columns, int keyField, int numTuples, int min,
    ...
    public static BTreeInternalPage createRandomInternalPage(BTreePageId pid, int keyField, int childPageCategory,
            int minKey, int maxKey, int minChildPtr) throws IOException {
     ...
     */
    public static BTreeInternalPage createRandomInternalPage(BTreePageId pid, int keyField, int childPageCategory,
            int numKeys, int minKey, int maxKey, int minChildPtr) throws IOException {
        byte[] data = BTreeFileEncoder.convertToInternalPage(
                BTreeUtility.generateRandomEntries(numKeys, pid.getTableId(), childPageCategory, minKey, maxKey,
                        minChildPtr),
    ...
    /**
     * A utility method to create a new BTreeFile with no data, assuming the path does not already exist. If the path
     * exists, the file will be overwritten. The new table will be added to the Catalog with the specified number of
     * columns as IntFields indexed on the keyField.
     */
    ...
    /**
     * A utility method to create a new BTreeFile with no data, with the specified number of pages, assuming the path
     * does not already exist. If the path exists, the file will be overwritten. The new table will be added to the
     * Catalog with the specified number of columns as IntFields indexed on the keyField.
     */
     ...
     *
     * @return a handle to the Thread that will attempt insertion after it has been started
     */
     ...
     *
     * @return a handle to the Thread that will attempt to search for tuple(s) after it has been started
     */
     ...
     *
     * @return a handle to the Thread that will attempt deletion after it has been started
     */
