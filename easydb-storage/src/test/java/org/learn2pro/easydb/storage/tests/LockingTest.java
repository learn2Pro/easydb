...
public class LockingTest extends TestUtil.CreateHeapFile {
     ...
     * @param expected true if we expect the second acquisition to succeed; false otherwise
     */
    ...
    /**
     * Unit test for BufferPool.getPage() assuming locking. Acquires a read lock and a write lock on the same page, in
     * that order.
     */
    @Test
    ...
    /**
     * Unit test for BufferPool.getPage() assuming locking. Acquires a write lock and a read lock on the same page, in
     * that order.
     */
    @Test
    ...
    /**
     * Unit test for BufferPool.getPage() assuming locking. A single transaction should be able to acquire a read lock
     * after it already has a write lock.
     */
    @Test
    ...
    /**
     * Unit test for BufferPool.getPage() and BufferPool.releasePage() assuming locking. Acquires read locks on
     * different pages.
     */
    @Test
