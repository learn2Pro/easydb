...
import org.learn2pro.easydb.storage.BTreeScan;
...
/**
 * Dumps the contents of a table. args[1] is the number of columns.  E.g., if it's 5, then BTreeScanTest will end up
 * dumping the contents of f4.0.txt.
 */
