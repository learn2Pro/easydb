...
import org.learn2pro.easydb.storage.tests.TestUtil.LockGrabber;
...
public class DeadlockTest extends TestUtil.CreateHeapFile {
    ...
    /**
     * Helper method to clean up the syntax of starting a LockGrabber thread. The parameters pass through to the
     * LockGrabber constructor.
     */
    ...
    /**
     * Not-so-unit test to construct a deadlock situation. t1 acquires p0.read; t2 acquires p1.read; t1 attempts
     * p1.write; t2 attempts p0.write. Rinse and repeat.
     */
    @Test
    ...
    /**
     * Not-so-unit test to construct a deadlock situation. t1 acquires p0.write; t2 acquires p1.write; t1 attempts
     * p1.write; t2 attempts p0.write.
     */
    @Test
    ...
    /**
     * Not-so-unit test to construct a deadlock situation. t1 acquires p0.read; t2 acquires p0.read; t1 attempts to
     * upgrade to p0.write; t2 attempts to upgrade to p0.write
     */
    @Test
