...
import org.learn2pro.easydb.storage.BTreeChecker;
import org.learn2pro.easydb.storage.BTreeEntry;
import org.learn2pro.easydb.storage.BTreeFile;
import org.learn2pro.easydb.storage.BTreeInternalPage;
import org.learn2pro.easydb.storage.BTreeLeafPage;
import org.learn2pro.easydb.storage.BTreePageId;
import org.learn2pro.easydb.storage.BTreeRootPtrPage;
import org.learn2pro.easydb.storage.BTreeUtility;
...
public class BTreeFileInsertTest extends SimpleDbTestBase {
    ...
    public void testSplitLeafPage() throws Exception {
        ...
        BTreeLeafPage leftChild = (BTreeLeafPage) Database.getBufferPool()
                .getPage(tid, e.getLeftChild(), Permissions.READ_ONLY);
        BTreeLeafPage rightChild = (BTreeLeafPage) Database.getBufferPool()
                .getPage(tid, e.getRightChild(), Permissions.READ_ONLY);
    ...
    public void testSplitRootPage() throws Exception {
        ...
        assertTrue(it.hasNext());
        BTreeEntry e = it.next();
        BTreeInternalPage leftChild = (BTreeInternalPage) Database.getBufferPool()
                .getPage(tid, e.getLeftChild(), Permissions.READ_ONLY);
        BTreeInternalPage rightChild = (BTreeInternalPage) Database.getBufferPool()
                .getPage(tid, e.getRightChild(), Permissions.READ_ONLY);
